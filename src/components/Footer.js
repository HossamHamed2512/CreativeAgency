export function Footer() {
  return `
    <footer class="relative bg-gray-dark pt-20 md:pt-32 overflow-hidden">
      
      <div class="absolute bottom-20 left-4 md:-left-8 z-0">
        <img src="/src/images/creative-agency/footer/element1.png" alt="Shape" class="opacity-50 md:opacity-70 w-16 md:w-auto">
      </div>
      <div class="absolute bottom-24 right-4 md:right-32 z-0">
        <img src="/src/images/creative-agency/footer/element2.png" alt="Shape" class="opacity-50 md:opacity-70 w-20 md:w-auto">
      </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 md:gap-8">
            ...
            <div class="lg:col-span-4 text-center lg:text-left">
              <div class="mb-10">
                ...
                <p class="text-white text-base md:text-sm mb-6 max-w-sm mx-auto lg:mx-0 leading-relaxed">
            ...
            <div class="lg:col-span-3 text-center lg:text-left">
              <div class="mb-10">
                <div class="mb-8 md:mb-6">
                  <h4 class="text-white text-xl md:text-lg font-bold mb-4 md:mb-3">Main Address</h4>
                  <p class="text-gray-400 text-base md:text-sm mx-auto lg:mx-0 max-w-xs leading-relaxed">
                    6801 Hollywood Blvd, Los Angeles, CA 90028
                  </p>
                </div>
                <div class="mb-6">
                  <h4 class="text-white text-xl md:text-lg font-bold mb-4 md:mb-3">Sub-Address</h4>
                  <p class="text-gray-400 text-base md:text-sm mx-auto lg:mx-0 max-w-xs leading-relaxed">
            ...
            <div class="lg:col-span-5">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-8">
                ...
                <div class="text-center lg:text-left">
                  <div class="mb-10">
                    <h4 class="text-white text-xl md:text-lg font-bold mb-5 md:mb-4">Our Link</h4>
                ...
                <div class="text-center lg:text-left">
                  <div class="mb-10">
                    <h4 class="text-white text-xl md:text-lg font-bold mb-5 md:mb-4">Contact</h4>
                    ...
                    <div class="flex gap-4 md:gap-3 mb-8 md:mb-6 justify-center lg:justify-start">
                      <div class="w-12 h-12 md:w-10 md:h-10 rounded-full bg-gray-800 flex items-center justify-center flex-shrink-0">
                        <i class="far fa-envelope text-white text-base md:text-sm"></i>
                      </div>
                      <div class="text-left">
                        <h6 class="text-white font-semibold mb-1.5 md:mb-1 text-base md:text-sm">Email</h6>
                    ...
                    <div class="flex gap-4 md:gap-3 justify-center lg:justify-start">
                      <div class="w-12 h-12 md:w-10 md:h-10 rounded-full bg-gray-800 flex items-center justify-center flex-shrink-0">
                        <i class="fas fa-phone text-white text-base md:text-sm"></i>
                      </div>
                      <div class="text-left">
                        <h6 class="text-white font-semibold mb-1.5 md:mb-1 text-base md:text-sm">Phone</h6>
