  ...
  return `
    ...
    <div id="preloader" class="fixed inset-0 z-[99999] bg-black flex items-center justify-center">
      <div class="relative">
        ...
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          <img src="./src/assets/images/creative-agency/loader.png" alt="Loading" class="w-12 h-12 object-contain">
        </div>
      </div>
    </div>
    ...
    <header class="fixed top-0 left-0 w-full z-[9999] px-4 py-4" id="header">
      <div class="container mx-auto">
        <div class=" dark:bg-primary-black light:bg-white border border-border-color dark:border-border-color light:border-gray-200 rounded-40 p-1 transition-colors duration-300">
          <div class="flex items-center justify-between">
            ...
            <nav class="hidden lg:flex items-center ml-30 flex-1">
              <ul class="flex items-center">
                <li>
                  <a href="index.html" class="nav-link block px-5 py-3  dark: light:text-gray-900 font-semibold text-base rounded-40 leading-none transition-all hover:text-primary hover:bg-gray-dark dark:hover:bg-gray-dark ">
                    Home
                  </a>
                </li>
                <li>
                  <a href="services.html" class="nav-link block px-5 py-3  dark: light:text-gray-900 font-semibold text-base rounded-40 leading-none transition-all hover:text-primary hover:bg-gray-dark dark:hover:bg-gray-dark ">
                    Services
                  </a>
                </li>
                <li>
                  <a href="about.html" class="nav-link block px-5 py-3  dark: light:text-gray-900 font-semibold text-base rounded-40 leading-none transition-all hover:text-primary hover:bg-gray-dark dark:hover:bg-gray-dark ">
                    About
                  </a>
                </li>
                <li>
                  <a href="projects.html" class="nav-link block px-5 py-3  dark: light:text-gray-900 font-semibold text-base rounded-40 leading-none transition-all hover:text-primary hover:bg-gray-dark dark:hover:bg-gray-dark ">
                    Projects
                  </a>
                </li>
                <li>
                  <a href="contact.html" class="nav-link block px-5 py-3  dark: light:text-gray-900 font-semibold text-base rounded-40 leading-none transition-all hover:text-primary hover:bg-gray-dark dark:hover:bg-gray-dark ">
                    Contact
                  </a>
                </li>
              </ul>
      ...
      <div id="mobileMenu" class="fixed top-0 left-0 w-[280px] h-screen bg-[#0a0a0a] dark:bg-[#0a0a0a] light:bg-white z-[10001] overflow-y-auto transition-transform duration-500 transform -translate-x-full">
        ...
        <div class="flex justify-end p-6">
          <button id="navbarClose" class="w-12 h-12 rounded-lg border border-white/20 dark:border-white/20 light:border-gray-200 flex items-center justify-center  dark: light:text-gray-900 transition-colors hover:bg-primary hover:text-heading hover:border-primary">
        ...
        <div class="px-6 mb-8">
          <a href="index.html" class="inline-block bg-white rounded-full px-8 py-4">
            <img src="./src/assets/images/creative-agency/logo/logo-main.png" alt="Logo" class="h-8">
          </a>
        </div>
        ...
        <nav class="px-6">
          <ul>
            <li class="border-b border-white/10">
              <a href="index.html" class="mobile-nav-link block py-4 text- text-base font-medium transition-colors hover:text-primary">
                Home
              </a>
            </li>
            <li class="border-b border-white/10">
              <a href="services.html" class="mobile-nav-link block py-4  text-base font-medium transition-colors hover:text-primary">
                Services
              </a>
            </li>
            <li class="border-b border-white/10">
              <a href="about.html" class="mobile-nav-link block py-4  text-base font-medium transition-colors hover:text-primary">
                About
              </a>
            </li>
            <li class="border-b border-white/10">
              <a href="projects.html" class="mobile-nav-link block py-4  text-base font-medium transition-colors hover:text-primary">
                Projects
              </a>
            </li
            <li class="border-b border-white/10"
              <a href="contact.html" class="mobile-nav-link block py-4  text-base font-medium transition-colors hover:text-primary">
                Contact
              </a>
            </li>
          </ul>
        ...
        <div class="px-6 mt-10">
          <h5 class=" mb-5 font-semibold text-base">Follow Us</h5>
          <ul class="flex gap-3 social-link">
            <li>
              <a href="#" class="w-11 h-11 rounded-full bg-white/10 flex items-center justify-center  hover:bg-primary hover:text-black transition-all">
...
export function initHeader() {
  ...
  // Mark active page - Enhanced version
  ...
  mobileNavLinks.forEach((link) => {
    const linkPage = link.getAttribute("href");
    link.classList.remove("active-mobile-page"); // Remove any existing active class
